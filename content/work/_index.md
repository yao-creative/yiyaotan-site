...
0. If I were to generalize: the role of the entrepreneur would be to make the world a bigger place for people. But admittedly this this is probably fuzzily measurable, but perhaps measuring revealed preferences of an individual and finding an aggregate positive sum over the market or society which cares is an easier way. Within this a lot of the relevation of new and interesting value could be reactions to new inventions. Most other goals and values are valid and relevant but are approximating metrics still upper bounded in mutual information on this fundamental measure sometimes multi-step abstracted. It's easy to see that this is the basis of value creation and hence profits as profits is the aggregate sum of value and value can only be measured/ realized during transaction when the customer pays for what utility they get (function of their preference) from a service, these are the priors/ casuality behind any economic transaction and thus fundamentals for a startup.
